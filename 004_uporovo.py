...
dp_pressure_heat_system = 0.4
number_valve_heat = 4                            #todo 

dp_min_heat_refill = 0.5                         #todo                                                                         
number_valve_heat_refill = 0                     #todo 

heat_pumps_circ_pressure = dp_pressure_heat_system + 0.5 + 0.3
...
dp_pressure_vent_system = 0.4

number_valve_vent = 6                              #todo 
...
print("hot_water")
print("hot_water_power -                  ", heat_power)
